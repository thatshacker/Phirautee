#script by thatshacker
#please subscribe our youtube Channal
<#
                 _____
              .-" .-. "-.
            _/ '=(0.0)=' \_
          /`   .='|m|'=.   `\	Author:thatshacker
          \________________ /	
      .--.__///`'-,__~\\\\~`	┌─┐┬ ┬┬┬─┐┌─┐┬ ┬┌┬┐┌─┐┌─┐
     / /6|__\// a (__)-\\\\	├─┘├─┤│├┬┘├─┤│ │ │ ├┤ ├┤ 
     \ \/--`((   ._\   ,)))	┴  ┴ ┴┴┴└─┴ ┴└─┘ ┴ └─┘└─┘
     /  \\  ))\  -==-  (O)(.   YouTube: THAT'S HACKER
    /    )\((((\   .  /)))))
   /  _.' /  __(`~~~~`)__
  //"\\,-'-"`   `~~~~\\~~`"-.
 //  /`"              `      `\
...
$alert = "https://raw.githubusercontent.com/thatshacker/Phirautee/master/defcon.jpg"
...
$Form.Close()
$background = "https://raw.githubusercontent.com/thatshacker/Phirautee/master/PhirauteeBackground-3.jpg"
